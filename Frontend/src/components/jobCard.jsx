...
function JobCard() {
    ...
    return (
        <div className="max-w-5xl my-5   bg-white rounded-lg shadow-md overflow-hidden border border-gray-200 p-6 ">
            ...
            <p className="list-disc list-inside text-gray-600  space-y-1">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. In sit tempora molestiae quo porro voluptatum! Illum vitae recusandae culpa exercitationem, non veritatis laborum quaerat odio molestiae, repellat sed blanditiis iusto!
            </p>
            ...
            {/* Learn More Button */}
            <button onClick={handleClick} className="mt-6 px-4 py-2 bg-blue-600 text-white rounded-md font-medium hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                Learn more
            </button>
        </div>
    );
